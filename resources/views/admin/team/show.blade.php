          ...
          <div class="card shadow-sm border-0 overflow-hidden">
            <div class="card-body">
              <div class="profile-avatar text-center">
                <a href="/files/photos/{{ $photo }}" target="_blank" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Klik untuk lihat foto">
                  <img src="/files/photos/{{ $photo }}" class="shadow" height="120" alt="">
                </a>
              </div>
