...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Team::factory(19)->create();
        Leader::factory(19)->create();
        Member::factory(19)->create();
        File::factory(19)->create();
        // Quiz_tryout::factory(75)->create();
        // Quiz_attempt::factory(50)->create();
        // Quiz_answer::factory(50)->create();
        // Quarter_tryout::factory(15)->create();
        ...
        Semifinal_tryout::factory(75)->create();
    }
}
